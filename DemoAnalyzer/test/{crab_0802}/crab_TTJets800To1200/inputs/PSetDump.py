...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIIFall17DRPremix/QCD_HT700to1000_TuneCP5_13TeV-madgraph-pythia8/AODSIM/PU2017_94X_mc2017_realistic_v11-v1/70001/FE846B27-DA84-E811-A32E-FA163EC6168E.root')
)
...
process.DVAOD = cms.EDAnalyzer("DVAnalyzerAOD",
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('DVAOD.root')
)
...
process.runseq = cms.Sequence(process.DVAOD)
